...
label start:
    ...
    label story2_3:
        ...
        menu :
            ...
            "ใช่แล้วละ":
                $ friendshipm1 += 2
                male1 "คิดไว้แล้วจริงๆด้วยสินะครับ"
        ...
        m "ถ้านายว่าอย่างนั้นก็ตามนั้นละ"
        ...
        girl1 "แล้วนี้ไปเกี่ยวอะไรกับเรื่องบ้าๆที่่พวกนายพูดถึงเนี่ย"
        hide mc shirt sad2 at left
        with dissolve
        show akechi2 at left
        male1 "เรื่องนั้นผมอธิบายให้ฟังเองละกันครับ"
        stop music fadeout 1.0
        ...
        show akechi2 at left
        with dissolve
        male1 "คุณทาคุโตะในโลกของผมนะเป็นนักวิจัยเกี่ยวกับโรคสุขภาพทางจิต"
        ...
        male1 "นั้นเป็นเหตุผลที่ให้คุณทาคุโตะเลือกเป็นนักวิจัยทางจิต"
        male1 "แต่สุดท้ายแล้วไม่ว่าจะพยายามเท่าไหร่อาการคุณก็ไม่สามารถรักษาได้"
        male1 "แทนที่คุณทาคุโตะเลือกจะเดินหน้าใช้ชีวิตต่อไป"
        male1 "คงเป็นช่วงนี้ละครับ ชีวิตผมจะถูกย้อนกลับมาที่วัยมัธยมปลาย"
        male1 "ซึ่งถ้ายอมรับแบบนี้ต้นเหตุคงไม่ผลจากคุณทาคุโตะแล้วละครับ"
        ...
        male1 "มันไม่ควรจะเป็นแบบนั้นใช่ไหมละครับ"
        ...
        male1 "ย้อนเวลาได้นี้วิเศษไปเลยนะครับ แต่ประเด็นที่ผมรู้ตัวคือทุกครั้งที่ผมย้อนเวลา"
        hide akechi smile2 at left
        show akechi2 at left
        male1 "คุณมักจะทำสิ่งที่เปลี่ยนไปในแต่ละครั้งต่างจากคนอื่นๆ"
        male1 "อีกอย่างเพราะว่าผมไม่ได้สนิทกับคุณมากตั้งแต่มัธยมต้นผมก็เลยไม่ได้คุยอะไรมากนอก"
        ...
        show satonaka warm sad2 at left
        with dissolve
        girl1 "หมอนั้นทิ้งไปแบบนี้เลยหรอ"
        girl1 "ถ้างั้นอธิบายมานะว่าเรื่องมันอะไรเนี่ย"
        play music "audio/Tsuiokunokakera.mp3"
        girl1 "คิดว่าเป็นเรื่องธรรมดา ทำไมมันเกี่ยวข้องกับนาย หมอนั้น"
        ...
        girl1 "ถ้าจากที่ฟังมานาก็ไม่ได้คิดกับฉันแค่เพื่อนสินะ"
    ...
    label greenend:
        ...
        "ขอบคุณทีอยู่ด้วยกันจนถึงตอนนี้นะ"
    ...
    label blueend:
        ...
        "เพราะเพื่อนๆ"
        "เพราะสังคม"
        "สิ่งทุกอย่างที่ผสมให้เป็นตัวเราในวันนี้ทำให้เรามีแนวคิดที่เปลี่ยนไปในทุกๆวัน"
