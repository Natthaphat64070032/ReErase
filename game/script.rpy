...
label start:
    ...
    label story2_3:
        ...
        "ก็เอาแต่อาศัยร้านสะดวกซื้อตลอดเลย ดีสุดก็แค่ข้าวปั้น"
        "ไม่มีเวลาจะทำอาหารกินเองด้วยซ้ำ ถึงจะเคยทำอาหารกินเองเพราะต้องประหยัดงบก็เถอะ"
        "เอาเถอะ ยังไงเรื่องนี้ก็มั่นใจที่สุดแล้ว"
        scene curry
        with dissolve
