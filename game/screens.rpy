...
screen quick_menu():
    ...
    if quick_menu:
        ...
        hbox:
            ...
            textbutton _("ข้อความอัตโนมัติ") action Preference("auto-forward", "toggle")
            textbutton _("บันทึก") action ShowMenu('save')
            textbutton _("บันทึกทันที") action QuickSave()
            textbutton _("โหลดทันที") action QuickLoad()
...
screen load():
    ...
    use file_slots(_("โหลดเกม"))


screen file_slots(title):

    default page_name_value = FilePageNameInputValue(pattern=_("หน้า {}"), auto=_("เซฟอัตโนมัติ"), quick=_("เซฟด่วน"))
